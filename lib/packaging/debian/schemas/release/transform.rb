        ...
        module Transform
          ...
          def self.raw_data(instance)
            ...
            if instance.files.any?(&:sha256)
              raw_data['SHA256'] = instance.files.each_with_object("\n") do |file, str|
                next if file.sha256.nil?
            ...
            if instance.files.any?(&:md5)
              raw_data['MD5Sum'] = instance.files.each_with_object("\n") do |file, str|
            ...
            if instance.files.any?(&:sha1)
              raw_data['SHA1'] = instance.files.each_with_object("\n") do |file, str|
                next if file.sha1.nil?
